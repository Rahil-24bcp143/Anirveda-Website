...
const AppContent = ({ symbols, heading }) => {
  ...
  // Check if current route is a IPL route
  const isMockRBIRoute = location.pathname.startsWith('/ipl') ||
  ...
  useEffect(() => {
    // Skip loading screen for IPL routes
    if (isMockRBIRoute) {
      setIsLoading(false);
      return;
    }
      ...
      {isLoading && !isMockRBIRoute ? (
        ...
        <>
          ...
          /> */}
            ...
            {/* IPL Simulation */}
            <Route path="/ipl" element={<Home />} />
            <Route path="/ipl/adminlogin" element={<AdminLogin />} />
            <Route path="/ipl/adminpanel" element={<AdminPanel />} />
            <Route path="/ipl/playerlogin" element={<PlayerLogin />} />
            <Route path="/ipl/playerpanel" element={<PlayerPanel />} />
            <Route path="/ipl/leaderboard" element={<LeaderBoard />} />
