...
export default function About() {
  return (
    <div className="flex flex-col overflow-hidden">
      {/* Mobile-Only Large Container - Desktop uses ContainerScroll */}
      <div className="lg:hidden">
        {/* Mobile: Large Container with Simple Layout */}
        <div className="w-full min-h-screen py-12 px-4 sm:px-6">
          {/* Title Section */}
          <div className="text-center mb-12">
            <h1 className="font-Bebas text-6xl sm:text-7xl uppercase text-primary leading-tight">
              About <br />
              <span className="text-6xl sm:text-7xl font-bold text-primary block">
                Anirveda
              </span>
            </h1>
          </div>

          {/* Main Content Container - Much Larger for Mobile */}
          <div className="mx-auto bg-black/20 backdrop-blur-sm rounded-3xl p-8 sm:p-12 shadow-2xl border border-primary/30">
            {/* Text Content */}
            <div className="space-y-8 mb-12">
              <p className="text-lg sm:text-xl text-justify text-secondary leading-relaxed font-medium">
            ...
            {/* Social Media Links - Large for Mobile */}
            <div className="flex justify-center gap-8 sm:gap-12 pt-8 border-t border-primary/30">
              <a href="https://www.instagram.com/anirveda_pdeu/" target="_blank" rel="noopener noreferrer" className="group">
                <Icon
                  icon="mdi:instagram"
                  color="#b69575"
                  className="cursor-pointer text-5xl sm:text-6xl hover:scale-110 transition-all duration-300 group-hover:drop-shadow-2xl"
                />
              </a>
              <a
      ...
      {/* Desktop: Original ContainerScroll Layout */}
